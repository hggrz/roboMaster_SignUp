						...
						<div class="col-xs-12">
							...
							<div class="well">
								<h1 class="grey lighter smaller">
									<span class="blue bigger-125"><i class="icon-sitemap"></i> 500</span> 上一步操作失败
								</h1>
								<hr />
								...
								<div>
									...
									<ul>
										<li><i class="icon-hand-right blue"></i> 检查是否按照指定大小上传压缩包</li>
										<li><i class="icon-hand-right blue"></i> 检查是否非常规操作</li>
