...
<html>
	...
	<body style="width:90%;margin-left: 5%;" >
		...
		<blockquote class="layui-elem-quote layui-quote-nm "style="border-color:#ffb64b ;font-size: 1.2em;">
		    <font style="color: #FF5722!important">  上传压缩文件须知</font>： <br>
		     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;支持上传压缩文件格式： [ <font class="red">.rar</font> 、<font class="red">.zip</font> ]  <br>
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上传文件最大上限：[3M]
		</blockquote>
		
		
		<form class="layui-form" action="<%=request.getContextPath()%>/Ba/Sys/Upload_file.do" id="example" name="example" lay-filter="example" method="post" enctype="multipart/form-data" >
