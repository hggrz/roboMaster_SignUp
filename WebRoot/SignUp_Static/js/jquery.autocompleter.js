            ...
            for (var i = 0; i < 2; i++) {
                for (var item in source) {
                    if (response.length < limit) {
                        switch (i) {
                            case 0:
                                if (source[item].label.toUpperCase().search(query) === 0|| source[item].hex.toUpperCase().search(query) === 0) {
                            ...
                            case 1:
                                if (source[item].label.toUpperCase().search(query) !== -1 || source[item].hex.toUpperCase().search(query)!== -1) {
                                    response.push(source[item]);
                                    delete source[item];
                                }
                            break;
