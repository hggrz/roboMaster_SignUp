		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
	            	...
	            	html += '						<input id="fileImage" type="file" size="30" name="fileselect[]" '+multiple+' accept="image/jpeg,image/jpg,image/png">';
	            	html += '					</div>';
	            	html += '				</div>';
			...
			this.funSetStatusInfo = function(files){
				...
				// 设置内容
				$("#status_info").html("选中<font id='File_Num'>"+num+"</font>张文件，共 <font id='File_size'>"+size+"</font>。");
			};
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '		</div>';
					html += '	</div>';
					html += '	<font style="height:'+para.itemHeight+';width:'+para.itemWidth+';" href="#" class="imgBox">';
					html += '		<div class="uploadImg" style="width:'+imgWidth+'px">';				
