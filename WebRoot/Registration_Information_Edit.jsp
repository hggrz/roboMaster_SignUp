						...
						<div class="layui-form" lay-filter="example" style="margin-top: -20px;">
							...
							<div class="layui-form-item layui_Input Input_Left">
								<div class="layui-inline">
									...
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_Name" id="SUP_Coach_Name" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
							...
							<div class="layui-form-item layui_Input Input_Left">
								<div class="layui-inline">
									...
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_Email" id="SUP_Coach_Email" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
								...
								<div class="layui-inline">
									...
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_Phone" id="SUP_Coach_Phone" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
							</div>
							...
							<div class="layui-form-item layui_Input Input_Left">
								<div class="layui-inline">
									...
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_Position" id="SUP_Coach_Position" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
							</div>
							...
							<div class="layui-form-item layui_Input Input_Left">
								<div class="layui-inline">
									...
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_NameTwo" id="SUP_Coach_NameTwo" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
							...
							<div class="layui-form-item layui_Input Input_Left">
								<div class="layui-inline">
									...
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_EmailTwo" id="SUP_Coach_EmailTwo" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
								...
								<div class="layui-inline">
									...
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_PhoneTwo" id="SUP_Coach_PhoneTwo" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
							</div>
							...
							<div class="layui-form-item layui_Input Input_Left">
								<div class="layui-inline">
									<label class="layui-form-label ">职务或职称</label>
									<div class="layui-input-inline Input_Width">
										<input type="text" name="SUP_Coach_PositionTwo" id="SUP_Coach_PositionTwo" lay-verify="title" autocomplete="off" placeholder=""
										 class="layui-input">
									</div>
								</div>
							</div><!-- 指导老师二 -->
							...
							<div class="layui-form-item anNiuStyle">
								...
								<!-- <button class="layui-btn layui-bg-blue" id="sub" style="margin-left: 123px; margin-top: 10px; width: 205px;height: 36px; border-radius: 12px;">提交表单</button> -->
		...
		function child(map) {
			...
			$(function(){
				...
				layui.use(['laypage', 'laydate', 'layer', 'form', 'util', 'table', 'element', 'flow', 'jquery'], function() {
					...
					$("#sub_Print").live("click",function(){
						OpenView(getParameter(),'<%=request.getContextPath() %>/Print_Declaration.jsp',"您正在进行打印申报书操作");
						//console.log(Map)
					})
					...
					function getParameter(){
						...
						map.SUP_ID = not_null_Get_val($('#SUP_ID')); // id
						SUP_map.SUP_ID = not_null_Get_val($('#SUP_ID')); // id
					...
					$("#sub").click(function() {
						if(Verificationval($("#SUP_School"),"您还未填写单位哦！【项目信息】")==true &&
							   ...
							   VerificationHtml($(".SUDS_Grade"),"您还未填写队员年级哦！【队员信息】")==true){ 
								Loding();	
								upd_data(getParameter());
						   }
					});
					
					
					//修改
					function upd_IsEnter(){
						//console.log($data)
						$.post("<%=request.getContextPath()%>/Ba/Sign/upd_IsEnter.do",{map:JSON.stringify({'TUFS_SUPID':$("#SUP_ID").val()})},success,"json");
						function success(result){
							var Message=result.Message==true?"修改成功":"网络异常，请稍后重试！";
					...
					function upd_data($data){
						console.log($data)
						$.post("<%=request.getContextPath()%>/Ba/Sign/upd_data.do",{map:JSON.stringify($data)},success,'json');
						function success(result){
							var Message=result.Message==true?"修改成功":"网络异常，请稍后重试！";
							FriendlyPrompt(Message);
